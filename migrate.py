...
AWS_REGION_NAME = os.environ.get('REGION')
...
def main():
    ddb = boto3.resource('dynamodb', endpoint_url='http://localhost:8000', region_name=AWS_REGION_NAME, aws_access_key_id=AWS_ACCESS_KEY, aws_secret_access_key=AWS_SECRET_KEY)
